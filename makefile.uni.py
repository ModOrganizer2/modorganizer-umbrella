...
for author, git_path, path, branch, dependencies, Build in [
    ...
    (config['Main_Author'], "modorganizer-tool_configurator", "tool_configurator", "Appveyor", ["PyQt5"], True),
    (config['Main_Author'], "modorganizer-fnistool", "fnistool", "Appveyor",  ["PyQt5"], True),
