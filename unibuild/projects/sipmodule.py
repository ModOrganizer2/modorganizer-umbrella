...
from unibuild.projects import sip, python
...
class SipModuleConfigure(build.Builder):
    ...
    def process(self, progress):
        soutpath = os.path.join(sip.sip["build_path"], "stdout.log")
        serrpath = os.path.join(sip.sip["build_path"], "stderr.log")
